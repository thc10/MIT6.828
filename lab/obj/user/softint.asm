...
sys_env_destroy(envid_t envid)
{
  ...
  8000ed:	00 
  8000ee:	c7 44 24 08 42 0e 80 	movl   $0x800e42,0x8(%esp)
  8000f5:	00 
  8000f6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8000fd:	00 
  8000fe:	c7 04 24 5f 0e 80 00 	movl   $0x800e5f,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80015d:	c7 04 24 70 0e 80 00 	movl   $0x800e70,(%esp)
  ...
  800173:	e8 51 00 00 00       	call   8001c9 <vcprintf>
	cprintf("\n");
  800178:	c7 04 24 94 0e 80 00 	movl   $0x800e94,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800205:	e8 b4 01 00 00       	call   8003be <vprintfmt>
	sys_cputs(b.buf, b.idx);
