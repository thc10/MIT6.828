...
sys_env_destroy(envid_t envid)
{
  ...
  800103:	00 
  800104:	c7 44 24 08 60 0e 80 	movl   $0x800e60,0x8(%esp)
  80010b:	00 
  80010c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800113:	00 
  800114:	c7 04 24 7d 0e 80 00 	movl   $0x800e7d,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800173:	c7 04 24 8c 0e 80 00 	movl   $0x800e8c,(%esp)
  ...
  800189:	e8 51 00 00 00       	call   8001df <vcprintf>
	cprintf("\n");
  80018e:	c7 04 24 54 0e 80 00 	movl   $0x800e54,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800338:	0f be 80 b0 0e 80 00 	movsbl 0x800eb0(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800453:	ff 24 8d 40 0f 80 00 	jmp    *0x800f40(,%ecx,4)
  ...
  80051f:	c7 44 24 08 d1 0e 80 	movl   $0x800ed1,0x8(%esp)
  800526:	00 
  ...
  800551:	b8 c1 0e 80 00       	mov    $0x800ec1,%eax
