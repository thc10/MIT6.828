...
sys_env_destroy(envid_t envid)
{
  ...
  800119:	00 
  80011a:	c7 44 24 08 70 0e 80 	movl   $0x800e70,0x8(%esp)
  800121:	00 
  800122:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800129:	00 
  80012a:	c7 04 24 8d 0e 80 00 	movl   $0x800e8d,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800189:	c7 04 24 9c 0e 80 00 	movl   $0x800e9c,(%esp)
  ...
  80019f:	e8 51 00 00 00       	call   8001f5 <vcprintf>
	cprintf("\n");
  8001a4:	c7 04 24 64 0e 80 00 	movl   $0x800e64,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800348:	0f be 80 c0 0e 80 00 	movsbl 0x800ec0(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800463:	ff 24 8d 50 0f 80 00 	jmp    *0x800f50(,%ecx,4)
  ...
  80052f:	c7 44 24 08 e1 0e 80 	movl   $0x800ee1,0x8(%esp)
  800536:	00 
  ...
  800561:	b8 d1 0e 80 00       	mov    $0x800ed1,%eax
