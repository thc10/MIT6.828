...
sys_env_destroy(envid_t envid)
{
  ...
  8000ec:	00 
  8000ed:	c7 44 24 08 42 0e 80 	movl   $0x800e42,0x8(%esp)
  8000f4:	00 
  8000f5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8000fc:	00 
  8000fd:	c7 04 24 5f 0e 80 00 	movl   $0x800e5f,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80015c:	c7 04 24 70 0e 80 00 	movl   $0x800e70,(%esp)
  ...
  800172:	e8 51 00 00 00       	call   8001c8 <vcprintf>
	cprintf("\n");
  800177:	c7 04 24 94 0e 80 00 	movl   $0x800e94,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800204:	e8 b5 01 00 00       	call   8003be <vprintfmt>
	sys_cputs(b.buf, b.idx);
