...
sys_env_destroy(envid_t envid)
{
  ...
  800107:	00 
  800108:	c7 44 24 08 52 0e 80 	movl   $0x800e52,0x8(%esp)
  80010f:	00 
  800110:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800117:	00 
  800118:	c7 04 24 6f 0e 80 00 	movl   $0x800e6f,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800177:	c7 04 24 80 0e 80 00 	movl   $0x800e80,(%esp)
  ...
  80018d:	e8 51 00 00 00       	call   8001e3 <vcprintf>
	cprintf("\n");
  800192:	c7 04 24 a4 0e 80 00 	movl   $0x800ea4,(%esp)
