...
sys_env_destroy(envid_t envid)
{
  ...
  8000f1:	00 
  8000f2:	c7 44 24 08 42 0e 80 	movl   $0x800e42,0x8(%esp)
  8000f9:	00 
  8000fa:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800101:	00 
  800102:	c7 04 24 5f 0e 80 00 	movl   $0x800e5f,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800161:	c7 04 24 70 0e 80 00 	movl   $0x800e70,(%esp)
  ...
  800177:	e8 51 00 00 00       	call   8001cd <vcprintf>
	cprintf("\n");
  80017c:	c7 04 24 94 0e 80 00 	movl   $0x800e94,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800209:	e8 b0 01 00 00       	call   8003be <vprintfmt>
	sys_cputs(b.buf, b.idx);
