...
umain(int argc, char **argv)
{
  ...
  800039:	c7 04 24 f8 0e 80 00 	movl   $0x800ef8,(%esp)
  ...
  800058:	c7 44 24 08 73 0f 80 	movl   $0x800f73,0x8(%esp)
  80005f:	00 
  800060:	c7 44 24 04 11 00 00 	movl   $0x11,0x4(%esp)
  800067:	00 
  800068:	c7 04 24 90 0f 80 00 	movl   $0x800f90,(%esp)
...
umain(int argc, char **argv)
{
  ...
  8000a6:	c7 44 24 08 18 0f 80 	movl   $0x800f18,0x8(%esp)
  8000ad:	00 
  8000ae:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  8000b5:	00 
  8000b6:	c7 04 24 90 0f 80 00 	movl   $0x800f90,(%esp)
...
exit(void)
{
  ...
  800140:	e8 ae 0a 00 00       	call   800bf3 <sys_env_destroy>
}
  800145:	c9                   	leave  
  800146:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800158:	e8 e8 0a 00 00       	call   800c45 <sys_getenvid>
  ...
  800173:	c7 04 24 c0 0f 80 00 	movl   $0x800fc0,(%esp)
  ...
  800189:	e8 51 00 00 00       	call   8001df <vcprintf>
	cprintf("\n");
  80018e:	c7 04 24 8e 0f 80 00 	movl   $0x800f8e,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002cf:	e8 9c 09 00 00       	call   800c70 <__udivdi3>
  ...
  80032f:	e8 6c 0a 00 00       	call   800da0 <__umoddi3>
  800334:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800338:	0f be 80 e4 0f 80 00 	movsbl 0x800fe4(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800453:	ff 24 8d 74 10 80 00 	jmp    *0x801074(,%ecx,4)
  ...
  80051f:	c7 44 24 08 05 10 80 	movl   $0x801005,0x8(%esp)
  800526:	00 
  ...
  800551:	b8 f5 0f 80 00       	mov    $0x800ff5,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c20:	00 
  800c21:	c7 44 24 08 e8 11 80 	movl   $0x8011e8,0x8(%esp)
  800c28:	00 
  800c29:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c30:	00 
  800c31:	c7 04 24 05 12 80 00 	movl   $0x801205,(%esp)
  800c38:	e8 0a f5 ff ff       	call   800147 <_panic>
...
00800c70 <__udivdi3>:
  ...
  800c76:	8b 44 24 28          	mov    0x28(%esp),%eax
  800c7a:	8b 7c 24 1c          	mov    0x1c(%esp),%edi
  800c7e:	8b 6c 24 20          	mov    0x20(%esp),%ebp
  800c82:	8b 4c 24 24          	mov    0x24(%esp),%ecx
  800c86:	85 c0                	test   %eax,%eax
  800c88:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800c8c:	89 ea                	mov    %ebp,%edx
  800c8e:	89 0c 24             	mov    %ecx,(%esp)
  800c91:	75 2d                	jne    800cc0 <__udivdi3+0x50>
  800c93:	39 e9                	cmp    %ebp,%ecx
  800c95:	77 61                	ja     800cf8 <__udivdi3+0x88>
  800c97:	85 c9                	test   %ecx,%ecx
  800c99:	89 ce                	mov    %ecx,%esi
  800c9b:	75 0b                	jne    800ca8 <__udivdi3+0x38>
  ...
  800caa:	89 e8                	mov    %ebp,%eax
  800cac:	f7 f6                	div    %esi
  800cae:	89 c5                	mov    %eax,%ebp
  800cb0:	89 f8                	mov    %edi,%eax
  800cb2:	f7 f6                	div    %esi
  800cb4:	89 ea                	mov    %ebp,%edx
  800cb6:	83 c4 0c             	add    $0xc,%esp
  800cb9:	5e                   	pop    %esi
  800cba:	5f                   	pop    %edi
  800cbb:	5d                   	pop    %ebp
  800cbc:	c3                   	ret    
  ...
  800cc2:	77 24                	ja     800ce8 <__udivdi3+0x78>
  800cc4:	0f bd e8             	bsr    %eax,%ebp
  800cc7:	83 f5 1f             	xor    $0x1f,%ebp
  800cca:	75 3c                	jne    800d08 <__udivdi3+0x98>
  800ccc:	8b 74 24 04          	mov    0x4(%esp),%esi
  800cd0:	39 34 24             	cmp    %esi,(%esp)
  800cd3:	0f 86 9f 00 00 00    	jbe    800d78 <__udivdi3+0x108>
  800cd9:	39 d0                	cmp    %edx,%eax
  800cdb:	0f 82 97 00 00 00    	jb     800d78 <__udivdi3+0x108>
  800ce1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  800ce8:	31 d2                	xor    %edx,%edx
  800cea:	31 c0                	xor    %eax,%eax
  800cec:	83 c4 0c             	add    $0xc,%esp
  800cef:	5e                   	pop    %esi
  800cf0:	5f                   	pop    %edi
  800cf1:	5d                   	pop    %ebp
  800cf2:	c3                   	ret    
  ...
  800cfa:	f7 f1                	div    %ecx
  800cfc:	31 d2                	xor    %edx,%edx
  800cfe:	83 c4 0c             	add    $0xc,%esp
  800d01:	5e                   	pop    %esi
  800d02:	5f                   	pop    %edi
  800d03:	5d                   	pop    %ebp
  800d04:	c3                   	ret    
  ...
  800d0a:	8b 3c 24             	mov    (%esp),%edi
  800d0d:	d3 e0                	shl    %cl,%eax
  800d0f:	89 c6                	mov    %eax,%esi
  800d11:	b8 20 00 00 00       	mov    $0x20,%eax
  800d16:	29 e8                	sub    %ebp,%eax
  800d18:	89 c1                	mov    %eax,%ecx
  800d1a:	d3 ef                	shr    %cl,%edi
  800d1c:	89 e9                	mov    %ebp,%ecx
  800d1e:	89 7c 24 08          	mov    %edi,0x8(%esp)
  800d22:	8b 3c 24             	mov    (%esp),%edi
  800d25:	09 74 24 08          	or     %esi,0x8(%esp)
  800d29:	89 d6                	mov    %edx,%esi
  800d2b:	d3 e7                	shl    %cl,%edi
  800d2d:	89 c1                	mov    %eax,%ecx
  800d2f:	89 3c 24             	mov    %edi,(%esp)
  800d32:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800d36:	d3 ee                	shr    %cl,%esi
  800d38:	89 e9                	mov    %ebp,%ecx
  800d3a:	d3 e2                	shl    %cl,%edx
  800d3c:	89 c1                	mov    %eax,%ecx
  800d3e:	d3 ef                	shr    %cl,%edi
  800d40:	09 d7                	or     %edx,%edi
  800d42:	89 f2                	mov    %esi,%edx
  800d44:	89 f8                	mov    %edi,%eax
  800d46:	f7 74 24 08          	divl   0x8(%esp)
  800d4a:	89 d6                	mov    %edx,%esi
  800d4c:	89 c7                	mov    %eax,%edi
  800d4e:	f7 24 24             	mull   (%esp)
  800d51:	39 d6                	cmp    %edx,%esi
  800d53:	89 14 24             	mov    %edx,(%esp)
  800d56:	72 30                	jb     800d88 <__udivdi3+0x118>
  800d58:	8b 54 24 04          	mov    0x4(%esp),%edx
  800d5c:	89 e9                	mov    %ebp,%ecx
  800d5e:	d3 e2                	shl    %cl,%edx
  800d60:	39 c2                	cmp    %eax,%edx
  800d62:	73 05                	jae    800d69 <__udivdi3+0xf9>
  800d64:	3b 34 24             	cmp    (%esp),%esi
  800d67:	74 1f                	je     800d88 <__udivdi3+0x118>
  800d69:	89 f8                	mov    %edi,%eax
  800d6b:	31 d2                	xor    %edx,%edx
  800d6d:	e9 7a ff ff ff       	jmp    800cec <__udivdi3+0x7c>
  800d72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  800d78:	31 d2                	xor    %edx,%edx
  800d7a:	b8 01 00 00 00       	mov    $0x1,%eax
  800d7f:	e9 68 ff ff ff       	jmp    800cec <__udivdi3+0x7c>
...
00800da0 <__umoddi3>:
  ...
  800da1:	57                   	push   %edi
  800da2:	56                   	push   %esi
  800da3:	83 ec 14             	sub    $0x14,%esp
  800da6:	8b 44 24 28          	mov    0x28(%esp),%eax
  800daa:	8b 4c 24 24          	mov    0x24(%esp),%ecx
  800dae:	8b 74 24 2c          	mov    0x2c(%esp),%esi
  800db2:	89 c7                	mov    %eax,%edi
  800db4:	89 44 24 04          	mov    %eax,0x4(%esp)
  800db8:	8b 44 24 30          	mov    0x30(%esp),%eax
  800dbc:	89 4c 24 10          	mov    %ecx,0x10(%esp)
  800dc0:	89 34 24             	mov    %esi,(%esp)
  800dc3:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  800dc7:	85 c0                	test   %eax,%eax
  800dc9:	89 c2                	mov    %eax,%edx
  800dcb:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  800dcf:	75 17                	jne    800de8 <__umoddi3+0x48>
  800dd1:	39 fe                	cmp    %edi,%esi
  800dd3:	76 4b                	jbe    800e20 <__umoddi3+0x80>
  800dd5:	89 c8                	mov    %ecx,%eax
  800dd7:	89 fa                	mov    %edi,%edx
  800dd9:	f7 f6                	div    %esi
  ...
  800dea:	77 54                	ja     800e40 <__umoddi3+0xa0>
  800dec:	0f bd e8             	bsr    %eax,%ebp
  800def:	83 f5 1f             	xor    $0x1f,%ebp
  800df2:	75 5c                	jne    800e50 <__umoddi3+0xb0>
  800df4:	8b 7c 24 08          	mov    0x8(%esp),%edi
  800df8:	39 3c 24             	cmp    %edi,(%esp)
  800dfb:	0f 87 e7 00 00 00    	ja     800ee8 <__umoddi3+0x148>
  800e01:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800e05:	29 f1                	sub    %esi,%ecx
  800e07:	19 c7                	sbb    %eax,%edi
  800e09:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  800e0d:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  800e11:	8b 44 24 08          	mov    0x8(%esp),%eax
  800e15:	8b 54 24 0c          	mov    0xc(%esp),%edx
  800e19:	83 c4 14             	add    $0x14,%esp
  800e1c:	5e                   	pop    %esi
  800e1d:	5f                   	pop    %edi
  800e1e:	5d                   	pop    %ebp
  800e1f:	c3                   	ret    
  ...
  800e50:	8b 04 24             	mov    (%esp),%eax
  800e53:	be 20 00 00 00       	mov    $0x20,%esi
  800e58:	89 e9                	mov    %ebp,%ecx
  800e5a:	29 ee                	sub    %ebp,%esi
  800e5c:	d3 e2                	shl    %cl,%edx
  800e5e:	89 f1                	mov    %esi,%ecx
  800e60:	d3 e8                	shr    %cl,%eax
  800e62:	89 e9                	mov    %ebp,%ecx
  800e64:	89 44 24 04          	mov    %eax,0x4(%esp)
  800e68:	8b 04 24             	mov    (%esp),%eax
  800e6b:	09 54 24 04          	or     %edx,0x4(%esp)
  ...
  800e7f:	89 e9                	mov    %ebp,%ecx
  800e81:	d3 e7                	shl    %cl,%edi
  800e83:	89 f1                	mov    %esi,%ecx
  800e85:	d3 e8                	shr    %cl,%eax
  800e87:	89 e9                	mov    %ebp,%ecx
  800e89:	09 f8                	or     %edi,%eax
  800e8b:	8b 7c 24 10          	mov    0x10(%esp),%edi
  800e8f:	f7 74 24 04          	divl   0x4(%esp)
  800e93:	d3 e7                	shl    %cl,%edi
  800e95:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  800e99:	89 d7                	mov    %edx,%edi
  800e9b:	f7 64 24 08          	mull   0x8(%esp)
  800e9f:	39 d7                	cmp    %edx,%edi
  800ea1:	89 c1                	mov    %eax,%ecx
  800ea3:	89 14 24             	mov    %edx,(%esp)
  800ea6:	72 2c                	jb     800ed4 <__umoddi3+0x134>
  800ea8:	39 44 24 0c          	cmp    %eax,0xc(%esp)
  800eac:	72 22                	jb     800ed0 <__umoddi3+0x130>
  800eae:	8b 44 24 0c          	mov    0xc(%esp),%eax
  800eb2:	29 c8                	sub    %ecx,%eax
  800eb4:	19 d7                	sbb    %edx,%edi
  800eb6:	89 e9                	mov    %ebp,%ecx
  800eb8:	89 fa                	mov    %edi,%edx
  800eba:	d3 e8                	shr    %cl,%eax
  800ebc:	89 f1                	mov    %esi,%ecx
  800ebe:	d3 e2                	shl    %cl,%edx
  800ec0:	89 e9                	mov    %ebp,%ecx
  800ec2:	d3 ef                	shr    %cl,%edi
  800ec4:	09 d0                	or     %edx,%eax
  800ec6:	89 fa                	mov    %edi,%edx
  800ec8:	83 c4 14             	add    $0x14,%esp
  800ecb:	5e                   	pop    %esi
  800ecc:	5f                   	pop    %edi
  800ecd:	5d                   	pop    %ebp
  800ece:	c3                   	ret    
  800ecf:	90                   	nop
  800ed0:	39 d7                	cmp    %edx,%edi
  800ed2:	75 da                	jne    800eae <__umoddi3+0x10e>
  800ed4:	8b 14 24             	mov    (%esp),%edx
  800ed7:	89 c1                	mov    %eax,%ecx
  800ed9:	2b 4c 24 08          	sub    0x8(%esp),%ecx
  800edd:	1b 54 24 04          	sbb    0x4(%esp),%edx
  800ee1:	eb cb                	jmp    800eae <__umoddi3+0x10e>
  800ee3:	90                   	nop
  800ee4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  800ee8:	3b 44 24 0c          	cmp    0xc(%esp),%eax
  800eec:	0f 82 0f ff ff ff    	jb     800e01 <__umoddi3+0x61>
  800ef2:	e9 1a ff ff ff       	jmp    800e11 <__umoddi3+0x71>
