...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 18             	sub    $0x18,%esp
	cprintf("hello, world\n");
  800039:	c7 04 24 58 0e 80 00 	movl   $0x800e58,(%esp)
  ...
  800051:	c7 04 24 66 0e 80 00 	movl   $0x800e66,(%esp)
...
exit(void)
{
  ...
  8000a1:	e8 5d 0a 00 00       	call   800b03 <sys_env_destroy>
}
  8000a6:	c9                   	leave  
  8000a7:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000d5:	e8 ec 09 00 00       	call   800ac6 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800126:	e8 b3 01 00 00       	call   8002de <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  80013e:	e8 83 09 00 00       	call   800ac6 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800248:	0f be 80 87 0e 80 00 	movsbl 0x800e87(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800363:	ff 24 8d 14 0f 80 00 	jmp    *0x800f14(,%ecx,4)
  ...
  80042f:	c7 44 24 08 a8 0e 80 	movl   $0x800ea8,0x8(%esp)
  800436:	00 
  ...
  800461:	b8 98 0e 80 00       	mov    $0x800e98,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b30:	00 
  800b31:	c7 44 24 08 88 10 80 	movl   $0x801088,0x8(%esp)
  800b38:	00 
  800b39:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b40:	00 
  800b41:	c7 04 24 a5 10 80 00 	movl   $0x8010a5,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ba0:	c7 04 24 b4 10 80 00 	movl   $0x8010b4,(%esp)
  800ba7:	e8 9f f5 ff ff       	call   80014b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800bac:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800bb0:	8b 45 10             	mov    0x10(%ebp),%eax
  800bb3:	89 04 24             	mov    %eax,(%esp)
  800bb6:	e8 2f f5 ff ff       	call   8000ea <vcprintf>
	cprintf("\n");
  800bbb:	c7 04 24 64 0e 80 00 	movl   $0x800e64,(%esp)
  800bc2:	e8 84 f5 ff ff       	call   80014b <cprintf>
