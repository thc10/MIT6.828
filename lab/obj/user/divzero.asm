...
umain(int argc, char **argv)
{
  ...
  800054:	c7 04 24 58 0e 80 00 	movl   $0x800e58,(%esp)
...
exit(void)
{
  ...
  8000a4:	e8 5a 0a 00 00       	call   800b03 <sys_env_destroy>
}
  8000a9:	c9                   	leave  
  8000aa:	c3                   	ret    
...
putch(int ch, struct printbuf *b)
{
  ...
  8000d8:	e8 e9 09 00 00       	call   800ac6 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800129:	e8 b0 01 00 00       	call   8002de <vprintfmt>
	sys_cputs(b.buf, b.idx);
  ...
  800141:	e8 80 09 00 00       	call   800ac6 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800248:	0f be 80 70 0e 80 00 	movsbl 0x800e70(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800363:	ff 24 8d 00 0f 80 00 	jmp    *0x800f00(,%ecx,4)
  ...
  80042f:	c7 44 24 08 91 0e 80 	movl   $0x800e91,0x8(%esp)
  800436:	00 
  ...
  800461:	b8 81 0e 80 00       	mov    $0x800e81,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b30:	00 
  800b31:	c7 44 24 08 74 10 80 	movl   $0x801074,0x8(%esp)
  800b38:	00 
  800b39:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b40:	00 
  800b41:	c7 04 24 91 10 80 00 	movl   $0x801091,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ba0:	c7 04 24 a0 10 80 00 	movl   $0x8010a0,(%esp)
  800ba7:	e8 a2 f5 ff ff       	call   80014e <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800bac:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800bb0:	8b 45 10             	mov    0x10(%ebp),%eax
  800bb3:	89 04 24             	mov    %eax,(%esp)
  800bb6:	e8 32 f5 ff ff       	call   8000ed <vcprintf>
	cprintf("\n");
  800bbb:	c7 04 24 64 0e 80 00 	movl   $0x800e64,(%esp)
  800bc2:	e8 87 f5 ff ff       	call   80014e <cprintf>
