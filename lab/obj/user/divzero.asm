...
umain(int argc, char **argv)
{
  ...
  800054:	c7 04 24 68 0e 80 00 	movl   $0x800e68,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800258:	0f be 80 80 0e 80 00 	movsbl 0x800e80(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800373:	ff 24 8d 10 0f 80 00 	jmp    *0x800f10(,%ecx,4)
  ...
  80043f:	c7 44 24 08 a1 0e 80 	movl   $0x800ea1,0x8(%esp)
  800446:	00 
  ...
  800471:	b8 91 0e 80 00       	mov    $0x800e91,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b40:	00 
  800b41:	c7 44 24 08 84 10 80 	movl   $0x801084,0x8(%esp)
  800b48:	00 
  800b49:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b50:	00 
  800b51:	c7 04 24 a1 10 80 00 	movl   $0x8010a1,(%esp)
