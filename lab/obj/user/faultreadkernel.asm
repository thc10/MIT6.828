	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800238:	0f be 80 79 0e 80 00 	movsbl 0x800e79(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800353:	ff 24 8d 08 0f 80 00 	jmp    *0x800f08(,%ecx,4)
  ...
  80041f:	c7 44 24 08 9a 0e 80 	movl   $0x800e9a,0x8(%esp)
  800426:	00 
  ...
  800451:	b8 8a 0e 80 00       	mov    $0x800e8a,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b20:	00 
  800b21:	c7 44 24 08 7c 10 80 	movl   $0x80107c,0x8(%esp)
  800b28:	00 
  800b29:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b30:	00 
  800b31:	c7 04 24 99 10 80 00 	movl   $0x801099,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800b90:	c7 04 24 a8 10 80 00 	movl   $0x8010a8,(%esp)
  ...
  800ba6:	e8 30 f5 ff ff       	call   8000db <vcprintf>
	cprintf("\n");
  800bab:	c7 04 24 cc 10 80 00 	movl   $0x8010cc,(%esp)
