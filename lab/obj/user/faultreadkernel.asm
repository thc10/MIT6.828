	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800248:	0f be 80 89 0e 80 00 	movsbl 0x800e89(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800363:	ff 24 8d 18 0f 80 00 	jmp    *0x800f18(,%ecx,4)
  ...
  80042f:	c7 44 24 08 aa 0e 80 	movl   $0x800eaa,0x8(%esp)
  800436:	00 
  ...
  800461:	b8 9a 0e 80 00       	mov    $0x800e9a,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b30:	00 
  800b31:	c7 44 24 08 8c 10 80 	movl   $0x80108c,0x8(%esp)
  800b38:	00 
  800b39:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b40:	00 
  800b41:	c7 04 24 a9 10 80 00 	movl   $0x8010a9,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ba0:	c7 04 24 b8 10 80 00 	movl   $0x8010b8,(%esp)
  ...
  800bb6:	e8 36 f5 ff ff       	call   8000f1 <vcprintf>
	cprintf("\n");
  800bbb:	c7 04 24 dc 10 80 00 	movl   $0x8010dc,(%esp)
